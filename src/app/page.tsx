...
export default function Home() {
  return (
    <main style={{maxWidth:"900px",margin:"0 auto",padding:"80px 24px"}}>
      ...
      <h1 style={{fontSize:"clamp(2rem,6vw,4rem)",fontWeight:900,letterSpacing:"-.04em",background:"linear-gradient(135deg,#fff,#888)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",marginBottom:"16px"}}>cafe website</h1>
